...
public:
   ...
   void onDraw(GraphContext&c)override{
       srand(time(nullptr)*(long)this);
       setBgColor(0xFF000000|rand());
       //if(getChildrenCount())findViewById(0)->setBgColor(getBgColor());
       Window::onDraw(c); 
   }
...
int main(int argc,const char*argv[]){
    ...
    printf("lv1=%p lv2=%p\r\n",lv1,lv2);
    w1->addChildView(lv1)->setId(0).setBgColor(0x80666666);
    w2->addChildView(lv2)->setId(0).setBgColor(0x80006666);
